### generated by caffe2fluid, your net is in class "VGG16" ###
...
class VGG16(Network):
    ...
    def custom_layer_factory(self):
        ...
        location = VGG16.custom_layers_path
        pk_dir = os.path.join(VGG16.custom_layers_path, pk_name)
        pk_paths.append((location, pk_dir))
...
def main():
    ...
    ret = VGG16.convert(npy_weight, fluid_model, outputs)
    if ret == 0:
