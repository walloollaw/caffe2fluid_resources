### generated by caffe2fluid, your net is in class "hello_net" ###
...
class hello_net(Network):
    ...
    def custom_layer_factory(self):
        ...
        location = hello_net.custom_layers_path
        pk_dir = os.path.join(hello_net.custom_layers_path, pk_name)
        pk_paths.append((location, pk_dir))
    ...
    def setup(self):
        self.feed('data')
        self.conv(5, 5, 10, 1, 1, relu=False, name='conv')
        self.max_pool(2, 2, 2, 2, True, name='pool')
        self.custom_layer('Select', slice_point=[0, 3], axis=1, name='pool_select1')

        self.feed('pool')
        self.custom_layer('Select', slice_point=[3, 6], axis=1, name='pool_select2')

        self.feed('pool')
        self.custom_layer('Select', slice_point=[6], axis=1, name='pool_select3')

        self.feed('pool_select1', 
                  'pool_select3')
        self.concat(1, name='concat_13')

        self.feed('concat_13', 
                  'pool_select2')
        self.concat(1, name='concat_132')
...
def main():
    ...
    ret = hello_net.convert(npy_weight, fluid_model, outputs)
    if ret == 0:
